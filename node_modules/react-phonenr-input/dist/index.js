...
var LRUCache = function () {
  ...
  function LRUCache() {
    ...
    _classCallCheck$6(this, LRUCache);
...
var PhoneNumberMatcher = function () {
  ...
  function PhoneNumberMatcher() {
    ...
    _classCallCheck$8(this, PhoneNumberMatcher);
...
var AsYouType = function () {
  ...
  */
	function AsYouType(defaultCountry, metadata) {
		_classCallCheck$9(this, AsYouType);
...
function (_Component) {
  ...
  function PhoneInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleReturnValue", function () {
      var _this$props = _this.props,
          withCountryMeta = _this$props.withCountryMeta,
          onChange = _this$props.onChange;
      var _this$state = _this.state,
          phoneNumber = _this$state.phoneNumber,
          country = _this$state.country;
      var data = withCountryMeta ? {
        phoneNumber: phoneNumber,
        country: lodash_omit(country, ['hasAreaCodes', 'isAreaCode', 'dialCode', 'regions'])
      } : phoneNumber;
      onChange(data);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelect", function (code) {
      return function (e) {
        ...
        _this.setState({
          ...
          return _this.handleReturnValue();
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollToCountry", function () {
      ...
      if (showCountries && iso2 !== 'intl') {
        var _this$activeCountry$c;

        _this.countryList.current.scrollTop = ((_this$activeCountry$c = _this.activeCountry.current) === null || _this$activeCountry$c === void 0 ? void 0 : _this$activeCountry$c.offsetTop) - 50;
      }
    });
  ...
  _createClass(PhoneInput, [{
    ...
    value: function render() {
      ...
      var _this$state3 = this.state,
          iso2 = _this$state3.country.iso2,
          phoneNumber = _this$state3.phoneNumber,
          showCountries = _this$state3.showCountries;
      var _this$props3 = this.props,
          ...
          listFlagStyles = _this$props3.listFlagStyles;
      var passableProps = lodash_omit(this.props, ['format', 'regions', 'defaultCountry', 'preferredCountries', 'buttonFlagStyles', 'listFlagStyles', 'withCountryMeta']);
      var isMobile = detectMobile.any();
      var toggleList = !isMobile ? this.toggleList : undefined;
      return React.createElement("div", {
        className: "react-phonenr-input"
